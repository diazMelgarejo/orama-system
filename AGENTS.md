...
- **Canonical implementation:** Perpetua-Tools (`diazMelgarejo/Perpetua-Tools`) owns `src/utils/endpoint_policy_core.py` and `.agent/endpoint-policy-contract.yml` on `main`.
