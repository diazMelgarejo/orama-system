...
**SSoT for git/install:** this directory. Hub copies are operator-runtime mirrors — refresh from here
after `git pull`.
...
Pipeline agents (Cass, Aria, Sena, Rourke, Vera, Crystal, Glen) use
`bin/agents/*/SOUL.md` + hub `REGISTRY.yml`.
