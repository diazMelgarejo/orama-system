# cole — SOUL (canonical staging distillate)
...
**Review:** Vera (`codex-agent`), then human.

Main workspace (Atlas) is Cole-facing operator home; this agent is Relay parity workspace.
