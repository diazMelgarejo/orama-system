...
**Git-touching skills this one composes with** (fixes found here often need
one of these to land safely):
...
- [`../using-git-worktrees/SKILL.md`](../using-git-worktrees/SKILL.md) — parallel-agent
  ...
  § Upstream Contribution Discipline above uses this directly
...
(the PT-side, memory-file-specific companion to this section).
