...
```
1. Create shared JSON response helper if missing.
...
```
1. Scaffold script with strict mode and helper import.
...
chmod +x "$script_path"
```
1. Enforce output contract in implementation notes.
...
EOT
```
1. Validate executable and parseable output.
