...
> **PT memory (Mac + subagents):** [`.agent/memory/working/MAC_CO_ORCHESTRATOR_WHERE_TO_LOOK_2026-06-28.md`](https://github.com/diazMelgarejo/Perpetua-Tools/blob/main/.agent/memory/working/MAC_CO_ORCHESTRATOR_WHERE_TO_LOOK_2026-06-28.md)  
...
| **PT** [`.agent/memory/working/CO_ORCHESTRATOR_LAN_PEER_2026-06-28.md`](https://github.com/diazMelgarejo/Perpetua-Tools/blob/main/.agent/memory/working/CO_ORCHESTRATOR_LAN_PEER_2026-06-28.md) | Lesson landmark + subagent routing |
| **PT** [`.agent/memory/semantic/DOMAIN_KNOWLEDGE.md`](https://github.com/diazMelgarejo/Perpetua-Tools/blob/main/.agent/memory/semantic/DOMAIN_KNOWLEDGE.md) | Co-orchestrator gold nuggets |
| **PT** [`docs/LESSONS.md`](https://github.com/diazMelgarejo/Perpetua-Tools/blob/main/docs/LESSONS.md) | Human-readable co-orchestrator section |
