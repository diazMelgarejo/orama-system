...
and orama's `git-history-surgery` skill after the 2026-07-18 PT PRs
...
- PT companion: `perplexity-api/Perpetua-Tools/scripts/review/repo_hygiene.py` (the reference `private_literal_values()` loader implementation) and `perplexity-api/Perpetua-Tools/.agent/memory/semantic/DOMAIN_KNOWLEDGE.md` § Cybersecurity / OpSec / SecOps
