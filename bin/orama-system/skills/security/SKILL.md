...
- PT companion: [`scripts/review/repo_hygiene.py`](https://github.com/diazMelgarejo/Perpetua-Tools/blob/main/scripts/review/repo_hygiene.py) (the reference `private_literal_values()` loader implementation) and [`docs/LESSONS.md`](https://github.com/diazMelgarejo/Perpetua-Tools/blob/main/docs/LESSONS.md) § Cybersecurity / OpSec / SecOps (public; local `$PERPETUA_TOOLS_PATH/.agent/memory/semantic/DOMAIN_KNOWLEDGE.md` is workspace-only)
