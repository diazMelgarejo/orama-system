...
Open and follow `bin/orama-system/skills/openclaw-skills/skills/openclaw-add-channel/SKILL.md` (relative to the repo root). Do not copy behavior from this wrapper.
