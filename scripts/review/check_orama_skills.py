...
KNOWN_FIELDS = {"name", "description", "when_to_use", "argument-hint", "arguments", "disable-model-invocation", "user-invocable", "allowed-tools", "disallowed-tools", "model", "effort", "context", "agent", "hooks", "paths", "shell", "version", "license", "compatibility", "parent_skill", "triggers", "canonical_path", "supersedes", "last_updated", "agent_compatibility", "layer", "upstream", "upstream_path", "origin"}
