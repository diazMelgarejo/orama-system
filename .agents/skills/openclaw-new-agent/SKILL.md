...
Open and follow `bin/orama-system/skills/openclaw-skills/skills/openclaw-new-agent/SKILL.md` (relative to the repo root). Do not copy behavior from this wrapper.
