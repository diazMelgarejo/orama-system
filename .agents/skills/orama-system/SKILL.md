...
The canonical system skill lives at `bin/skills/SKILL.md` (v0.9.9.7). Always load it when working on this repository for the full ultrathink methodology, AFRP gate, CIDF rules, and 6 directives.
