...
Open and follow `bin/orama-system/skills/openclaw-skills/skills/openclaw-restart/SKILL.md` (relative to the repo root). Do not copy behavior from this wrapper.
