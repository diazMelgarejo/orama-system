<!-- autoplan restore: 2026-07-31-010 phase6 sync (gstack projects/orama-system) -->
...
**DX scope:** included, the primary users are operators and coding agents
invoking shell, hooks, and repository skills
