...
1. Run `cd ~/code/oramasys/perpetua-core && python -m pytest tests/ -v` → expect 32 passing
2. Run `cd ~/code/oramasys/oramasys && python -m pytest tests/ -v` → expect 4 passing
