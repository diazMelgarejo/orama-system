...
| Doc | Topic | Self-reported status (2026-07-22) |
|---|---|---|
...
| `2026-07-24-plan-unified-identity-audit.md` | Background/rationale for consolidating 3 separate git-identity allowlists into one config + engine | Superseded as the active execution path by `docs/plans/2026-07-24-unified-identity-audit-integrated-plan.md` (Phase 1 already landed, `b1f70018`) — kept for its verified root-cause analysis |
