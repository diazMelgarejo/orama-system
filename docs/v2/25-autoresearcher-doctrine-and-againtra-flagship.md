...
| G4 | **Git identity** | Allowlist: `cyre <Lawrence@cyre.me>`, `cyre <diazMelgarejo@gmail.com>`, `Codex <codex@openai.com>`, `cyre <Lawrence@bettermind.ph>`, `cursoragent@cursor.com`. Co-author: `Claude Sonnet 4.6 <noreply@anthropic.com>`. FORBIDDEN: `darth.serious@gmail.com` / `darth.Serious` / `nimbosa`. |
...
**Output:** `docs/v2/27-oramasys-v2-harmonization-blueprint.md` — the "intentional community"
