...
- [Offline/sandbox agent report](references/offline-sandbox-agent-report.md) — canonical close-out for agents with no LAN / not on the same machine (dual-authority with Perpetua-Tools `docs/coordination/offline-sandbox-agent-report.md`; shared skill `offline-sandbox-agent-report`).
