...
def test_read_discovery_peer_ip_normalizes_scheme_contaminated_value(monkeypatch, tmp_path):
...
def test_read_discovery_peer_ip_rejects_malformed_value(monkeypatch, tmp_path):
...
def test_read_discovery_peer_ip_passes_through_bare_ip_unchanged(monkeypatch, tmp_path):
